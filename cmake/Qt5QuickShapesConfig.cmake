# Temporary placeholder for Qt5::QuickShapes that is mysteriously missing from Qt 5.12 release
...
get_filename_component(_qt5QuickShapes_install_prefix "${Qt5Core_DIR}/../../../" ABSOLUTE)

# For backwards compatibility only. Use Qt5QuickShapes_VERSION instead.
set(Qt5QuickShapes_VERSION_STRING 5.12.1)
...
macro(_populate_QuickShapes_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::QuickShapes PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5QuickShapes_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5QuickShapes_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/QtQuickShapes/5.12.1"
        "${_qt5QuickShapes_install_prefix}/include/QtQuickShapes/5.12.1/QtQuickShapes"
    )
    ...
    set(Qt5QuickShapes_DEFINITIONS -DQT_QUICKCONTROLS2_LIB)
    set(Qt5QuickShapes_COMPILE_DEFINITIONS QT_QUICKCONTROLS2_LIB)
    set(_Qt5QuickShapes_MODULE_DEPENDENCIES "Quick;Gui;Core")
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.1 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    set(_Qt5QuickShapes_LIB_DEPENDENCIES "Qt5::Quick;Qt5::Gui;Qt5::Core")
    ...
    _populate_QuickShapes_target_properties(RELEASE "Qt5QuickShapes.dll" "Qt5QuickShapes.lib" )



    _populate_QuickShapes_target_properties(DEBUG "Qt5QuickShapesd.dll" "Qt5QuickShapesd.lib" )



    file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5QuickShapes_*Plugin.cmake")

    macro(_populate_QuickShapes_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        set_property(TARGET Qt5::${Plugin} APPEND PROPERTY IMPORTED_CONFIGURATIONS ${Configuration})

        set(imported_location "${_qt5QuickShapes_install_prefix}/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickShapes_check_file_exists(${imported_location})
