# Temporary placeholder for Qt5::QuickTemplates2 that is mysteriously missing from Qt 5.12 release
...
get_filename_component(_qt5QuickTemplates2_install_prefix "${Qt5Core_DIR}/../../../" ABSOLUTE)

# For backwards compatibility only. Use Qt5QuickTemplates2_VERSION instead.
set(Qt5QuickTemplates2_VERSION_STRING 5.12.1)
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.12.1"
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.12.1/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.1 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
